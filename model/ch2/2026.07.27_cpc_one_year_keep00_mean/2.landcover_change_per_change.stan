...
//    real b_landcover_base; //effect of development or forest, across routes
  ...
  vector[Nsp] b_landcover_change = b_landcover_change_mean + b_landcover_change_raw * sig_lcc;
...
//      a_sp[sp[n]] +
    ...
    b_landcover_change_mean ~ std_normal();
    sig_lcc ~ normal(0,.5); //explore more space
...
//    b_landcover_base ~ normal(0,1);
    ...
    sigma ~ normal(0,.5); //explore more space than an exponential
